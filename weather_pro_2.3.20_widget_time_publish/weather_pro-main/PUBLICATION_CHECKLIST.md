...
- Release APK и Release AAB собираются через GitHub Actions workflow `Build Weather Pro Android`.
...
- fastlane changelog для `versionCode 25` добавлен.
...
4. Для публикации использовать `app-release.aab` из артефакта `Weather-Pro-builds`.
